...
const solvePriceStock = (product, subProducts) => {
...
const getTopSellHelper = (req) => __awaiter(void 0, void 0, void 0, function* () {
    let find = {
        deleted: false,
    };
    ...
    try {
        ...
        for (const pro of products) {
            ...
            if (subProducts.length > 0) {
                (0, exports.solvePriceStock)(pro, subProducts);
            }
        }
        res.json({
            code: 200,
        ...
        if (price) {
            ...
            for (const product of products) {
                if (product.productType === "variations") {
                    if (subSet.has(String(product._id))) {
                        ...
                        (0, exports.solvePriceStock)(product, allSubs);
                        data.push(product);
                    }
                }
                else {
            ...
            for (const product of products) {
                if (product.productType === "variations") {
                    ...
                    if (subProducts.length > 0) {
                        (0, exports.solvePriceStock)(product, subProducts);
                    }
                }
                data.push(product);
            }
...
const topSell = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { products, products_info } = yield (0, exports.getTopSellHelper)(req);
        res.json({
            code: 200,
            message: "OK",
            data: {
...
const lowQuantity = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const subProducts = yield subProduct_model_1.default.find(find)
            .sort({ stock: "asc" })
            .lean();
        yield (0, exports.solveOptionSubProduct)(subProducts);
